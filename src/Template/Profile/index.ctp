 ...
 * @var \App\Model\Entity\Profile[]|\Cake\Collection\CollectionInterface $profile
 */
?>
    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('intro') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= h($profile->intro) ?></td>
                <td><?= $this->Number->format($profile->user) ?></td>
                <td class="actions">
